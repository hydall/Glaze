...
const props = defineProps({
  ...
  historyHidePreview: {
    type: Object,
    default: () => ({ count: 0, tokens: 0 })
  },
  contextSegments: {
    type: Object,
    default: () => ({ used: [], reserve: null })
  },
  contextLegendItems: {
    type: Array,
    default: () => []
...
.tokenizer-segment.chat-context-character {
  background-color: #ff6b6b;
}

.tokenizer-segment.chat-context-preset {
  background-color: #4ecdc4;
}

.tokenizer-segment.chat-context-summary {
  background-color: #95e1d3;
}

.tokenizer-segment.chat-context-memory {
  background-color: #a8e6cf;
}

.tokenizer-segment.chat-context-authors-note {
  background-color: #ffd93d;
}

.tokenizer-segment.chat-context-history {
  background-color: #6c5ce7;
}

.tokenizer-segment.chat-context-reserve {
  background-color: #a8dadc;
}

.tokenizer-segment.chat-context-lorebook {
  background-color: #f4a261;
}

.tokenizer-segment.chat-context-vector-lore {
