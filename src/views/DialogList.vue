...
<template>
  <div class="view-content-wrapper">
      <div class="list-container">
          <div v-for="chat in filteredChats" :key="chat.id + chat.sessionId" class="list-item" :class="{ unread: unread[chat.id] && chat.isCurrent }" v-long-press="() => openActions(chat)" @click="handleItemClick($event, chat)" @contextmenu.prevent="openActions(chat)">
            <div class="avatar">
