...
const _sessionTables = <(String, String)>[
  ...
  ('ledger_reconciliation_leases', 'session_id'),
...
Future<void> _seedCharacter(
  ...
  final statements = <String>[
    ...
    "INSERT INTO ledger_reconciliation_leases (session_id, owner_id, purpose, lease_expires_at, acquired_at) VALUES ('$sessionId', 'owner_$id', 'normal', 2, 1)",
