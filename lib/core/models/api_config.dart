...
abstract class ApiConfig with _$ApiConfig {
  const factory ApiConfig({
    ...
    @Default(true) bool omitTemperature,
    @Default(true) bool omitTopP,
    @Default(true) bool omitTopK,
    @Default(true) bool omitFrequencyPenalty,
    @Default(true) bool omitPresencePenalty,
