    ...
    return MenuGroup(
      ...
      items: [
        ...
        toggle(
          ...
          label: 'menu_confirm_message_delete'.tr(),
          description: 'desc_confirm_message_delete'.tr(),
          value: settings.confirmMessageDelete,
          onChanged: (v) => notifierOf(
            ref,
          ).save(settings.copyWith(confirmMessageDelete: v)),
        ),
      ],
    );
  }
